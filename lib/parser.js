...
module.exports = function parse(line) {
    ...
    if (keys[0] === GRAMMAR.CREATE_START) {
        ...
        statement += generateIndentation(indentLevel) + 'var ' + GRAMMAR.NAME + ' = ' + CHAR.QUOTE + vesselName + CHAR.QUOTE + CHAR.SEMICOLON + CHAR.NEWLINE;
    }
    ...
    if (keys[0] === GRAMMAR.CREATE_END) {
        ...
        for (var i in properties) {
            statement += generateIndentation(indentLevel) + properties[i] + ': ' + properties[i] + CHAR.COMMA + CHAR.NEWLINE;            
        }
    ...
    if (keys[0] === GRAMMAR.NOTE || keys[0] === GRAMMAR.PROGRAM || keys[0] === GRAMMAR.USAGE) {
        ...
        statement += generateIndentation(indentLevel) + 'var ' + propertyName + ' = ' + CHAR.QUOTE + propertyValue + CHAR.QUOTE + CHAR.SEMICOLON + CHAR.NEWLINE;
    }
